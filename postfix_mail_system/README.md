...
These are the accompanying config files and scripts for my blog post 

> [Building a Postfix-based mail system for incoming and outgoing email, capable of successfully sending one million emails per day](foo.bar)

There are five folders which I'll explain the contents of below.
